	...
	variants: {
		state: {
			...
			error: {
				...
				icon: "border-error-50 bg-error-100 bg-error-100 dark:bg-error-500/5 dark:border-error-500/30 dark:text-error-400",
				deleteButton:
		...
		<div className={container()}>
			...
			{state === "error" ? (
				<div className="flex flex-1 flex-col items-start gap-1">
					...
					<button
						className="text-sm font-medium text-error-700 hover:text-error-900
				...
				<div className="flex flex-1 flex-col items-start gap-1">
					...
					<div className="flex w-full items-center gap-3 ">
						<div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
							<div
								className="h-2 rounded-full w-4/5 bg-violet-600 dark:bg-violet-300"
