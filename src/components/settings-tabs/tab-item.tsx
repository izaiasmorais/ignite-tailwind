...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
	return (
		<Tabs.Trigger
			...
			data-[state=active]:text-violet-700 outline-none group dark:text-zinc-300
			dark:data-[state=active]:text-violet-300 dark:hover:text-violet-300"
		>
			<span
				className="rounded group-focus-visible:ring-2 group-focus-visible:ring-violet-400
			group-focus-visible:ring-offset-4 whitespace-nowrap"
			>
				{title}
			</span>
